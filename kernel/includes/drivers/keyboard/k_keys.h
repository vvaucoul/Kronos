...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/30 11:06:30 by vvaucoul          #+#    #+#             */
/*   Updated: 2024/10/24 11:33:09 by vvaucoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @file k_keys.h
 * @brief Header file containing keyboard key definitions.
 *
 * This file defines constants for various keyboard keys using hexadecimal values.
 * Each key is assigned a unique hexadecimal value.
 * These constants can be used to identify specific keys in keyboard-related operations.
 */
...
#define KEY_LEFTMETA 0xDB
#define KEY_RIGHTMETA 0xDC
#define KEY_COMPOSE 0xDD
